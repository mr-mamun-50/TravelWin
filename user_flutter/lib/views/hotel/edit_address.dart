...
class EditHotelAddress extends StatefulWidget {
  const EditHotelAddress({super.key});

  @override
  State<EditHotelAddress> createState() => _EditHotelAddressState();
}

class _EditHotelAddressState extends State<EditHotelAddress> {
...
//__Update latitude and longitude__
  Future<void> _updateGuideLatLng() async {
    if (formKey.currentState!.validate()) {
      ...
      ApiResponse apiResponse = await updateHotelLatLng(
